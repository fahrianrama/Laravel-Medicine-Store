...
<div class="container mb-5">
    <h2 class="text-danger text-center mt-5 fw-bolder">Pesanan Terkirim</h2>
    <p class="fs-6 mb-5 text-center text-secondary">Daftar pesanan yang telah berhasil</p>
    <div class="card">
        <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs">
                <li class="nav-item">
                    <a class="nav-link" aria-current="true" href="{{ route('orders') }}"> <span><i class="fa-solid fa-bell"></i></span> Berlangsung</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="{{ route('orders.success') }}"> <span><i class="fa-solid fa-check"></i></span> Berhasil</a>
                </li>
            </ul>
        </div>
        <div class="card-body">
