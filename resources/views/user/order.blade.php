    ...
    <div class="card">
        <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('myorder.success') }}"> <span><i class="fa-solid fa-check"></i></span> Berhasil</a>
                </li>
            </ul>
        </div>
        <div class="card-body">
            <!-- all order -->
            <div class="row">
                @foreach($orders->sortByDesc('status') as $order)
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="{{ route('checkout', $order->id) }}" type="button" class="btn btn-success">Konfirmasi</a>
                            </div>
                        </div>
                    </div>
                </div>
